...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-24 px-6 sm:px-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">
                {/* Step number */}
                <div className="flex items-center gap-4 mb-6">
                  <span className="text-5xl font-bold bg-gradient-to-br from-emerald-400 to-cyan-500 bg-clip-text text-transparent">
                    {step.number}
                  </span>
