  ...
  return (
    <section className="py-24 px-6 sm:px-10">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Requirements card */}
        <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-8 sm:p-10">
        ...
        {/* Pro tip */}
        <div className="mt-8 flex items-start gap-4 bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
